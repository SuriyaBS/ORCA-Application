  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:Container(
        ...
        //         image: AssetImage('assets/image/hackbackground1.webp'),
        //         fit: BoxFit.cover)
        // ),
             ...
             child:Row(
               ...
               children: <Widget>[
                 ElevatedButton(onPressed: (){
                   if(email=="John@gmail.com"&& password=="suri"){
                     Navigator.push(context, MaterialPageRoute(builder: (ctxt)=>MyApp2()));
                   }
                   else{
                     showDialog(context: context, builder: (ctxt)=>AlertDialog(
                       title: Text("Incorrect User Id or Password",
                         style: TextStyle(
                           fontSize: 20,
                           fontWeight: FontWeight.bold,
                         ),),
